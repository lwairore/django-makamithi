from home_two.suburls.visit_now_cta_section import VISIT_NOW_CTA_SECTION_ROOT_ROUTE, URL_FILE_NAME_WITHOUT_EXTENSION as VISIT_NOW_CTA_SECTION_URL_FILE_NAME_WITHOUT_EXTENSION
